	...
	void Update () {
		if(clicked) {
			...
			if (Input.GetKeyUp (KeyCode.CapsLock)) {
				PlayerPrefs.SetString ("block-breaker-left-control-text", "CAPS LOCK");
				text.text = "CAPS LOCK";
				leftControl = (int)KeyCode.CapsLock;
				PlayerPrefs.SetInt ("block-breaker-left-control", leftControl);
				clicked = false;
			}
			...
			if (Input.GetKeyUp (KeyCode.Space)) {
				PlayerPrefs.SetString ("block-breaker-left-control-text", "SPACE");
				text.text = "SPACE";
				leftControl = (int)KeyCode.Space;
				PlayerPrefs.SetInt ("block-breaker-left-control", leftControl);
				clicked = false;
			}
